...
<div class="multicolumna5columnas">
    ...
    <input type="text" id="txtcode" name="txtcode" value="<?php echo $value->getCODIGO(); ?>"/>
</div>
<div class="control-group">
    <span class="control-label">MENSAJE : </span>
    <input type="text" id="txtmsn" name="txtmsn" value="<?php echo $value->getMENSAJE(); ?>"/>
    <a id="ejemplo2"> <i class="icon-asterisk"></i> </a>
</div>
<div class="control-group">
    <span class="control-label">PATERNO : </span>
    <input type="text" id="txtpat" name="txtpat" value="<?php echo $value->getPATERNO(); ?>"/>
    <a id="ejemplo3"> <i class="icon-asterisk"></i> </a>
</div>
<div class="control-group">
    <span class="control-label">MATERNO : </span>
    <input type="text" id="txtmat" name="txtmat" value="<?php echo $value->getMATERNO(); ?>"/>
    <a id="ejemplo4"> <i class="icon-asterisk"></i> </a>
</div>
<div class="control-group">
    <span class="control-label">NOMBRES : </span>
    <input type="text" id="txtname" name="txtname" value="<?php echo $value->getNOMBRES(); ?>"/>
    <a id="ejemplo5"> <i class="icon-asterisk"></i> </a>
</div>
<div class="control-group">
    <span class="control-label">DNI : </span>
    <input type="text" id="txtdni" name="txtdni" maxlength="8" value="<?php echo $value->getDNI(); ?>"/>
...
<div class="control-group">
    ...
    <option value='<?php echo $value->getRESPONSABLES(); ?>'><?php echo $value->getRESPONSABLES(); ?></option>        
    <?php 
    $lis2=$cli->ListUser();
...
<div class="control-group">
    ...
    <input type="text" id="txtcel" name="txtcel" class="span4" value="<?php echo $value->getCELULAR(); ?>"/>
    <a id="ejemplo7"> <i class="icon-asterisk"></i> </a>
</div>
<div class="control-group">
    <span class="control-label">FIJO : </span>
    <input type="text" id="txtfijo" name="txtfijo" class="span4" value="<?php echo $value->getFIJO(); ?>"/>
    <a id="ejemplo8"> <i class="icon-asterisk"></i> </a>
</div>
<div class="control-group">
    <span class="control-label">DIRECCION : </span>
    <input type="text" id="txtdire" name="txtdire" class="span5" value="<?php echo $value->getDIRECCION(); ?>"/>
...
<div class="control-group">
    ...
    <select class="span3" id="txtdistrito" name="txtdistrito">
        <option value='<?php echo $value->getDISTRITO(); ?>'><?php echo $value->getDISTRITO(); ?></option>
    <?php 
...
<div class="control-group">
    ...
    <center><button class="btn btn-success"><a href="manteincli.php">VER TODOS LOS CLIENTES</a></button></center>
</div>
</center>
