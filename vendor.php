...
<a href="#myModal" role="button" class="btn btn-danger btn btn-small" data-toggle="modal">SPEECH</a>
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    ...
    <h4 class="text-error">LO FELICITO POR LA DESICI&Oacute;N TOMADA HA SIDO UN PLACER HABER CONVERSADO CON USTED, LE AGRADEZCO POR SU TIEMPO, QUE TENGA UN EXCELENTE D&Iacute;A!!!!!!</h4>
  </div>
