...
<div style="width: 95%; text-align: justify">
    ...
    <table class="table">
        ...
        <tbody>
            <?php 
$lsta=$llime->ListarMiTrabajoAgendado($_SESSION['codigo']);
while ($roww = mysql_fetch_array($lsta)) {
            echo "
                ...
                <td>$roww[3]</td>
                <td>$roww[4]</td>
                <td class='text-center'><a TARGET='_blank' href='procesa7.php?codecli=$roww[5]'><i class='icon icon-bullhorn'></i> SEND</a></td>
                </tr>
                ";
}
            ?>
